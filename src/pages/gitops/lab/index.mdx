...
3. Add, Commit and Push the changes to multi-tenancy-gitops. In the multi-tenancy-gitops folder: Add, Commit and Push the changes to multi-tenancy-gitops repository.
```
git add .
